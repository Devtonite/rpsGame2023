...
describe('Player 1 (ROCK) vs Player 2 (SCISSORS)', () => {
  ...
  it('Proves P2 chooses scissors', async () => {
    p2Move = Field(3); // scissors
  ...
  it('Proves P1 wins because rock beats scissors', async () => {
  ...
  it('Throws error if P2 tries to wins', async () => {
